...
export default function Header (photograph,) {
  ...
  // Exo : faites en sorte d'ouvrir / fermer la modale à l'aide du hook useState(). 
  // Les classes CSS sont openModal / closeModal
    ...
    <>
      <div className={handleModal}>
        <div className="header__modal">
          ...
          <FontAwesomeIcon icon={faXmark} className="icone__close__modal" onClick={closeModal}></FontAwesomeIcon>
        </div>
      ...
      <header className="header__photographer">
        ...
        <section className="header__presentation">
          ...
          <div className="contact__block">
            <button className="photographer__contact" onClick={openModal}>
              Contactez-moi
            </button>
          </div>
